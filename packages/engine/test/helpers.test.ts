...
const MODES: Mode[] = [
  ...
  },
  {
    name: 'color knockout',
    image: scene,
    patch: { mode: 'color', paletteSize: 6, layering: 'knockout' },
  },
  {
    name: 'color knockout, grouped',
    image: scene,
    patch: { mode: 'color', paletteSize: 6, layering: 'knockout', groupByColor: true },
  },
  {
    name: 'color knockout, unoptimized',
    image: scene,
    patch: { mode: 'color', paletteSize: 6, layering: 'knockout', optimizeSvg: false },
  },
  {
    name: 'color trap, overlap',
    image: scene,
    patch: { mode: 'color', paletteSize: 6, layering: 'trap', gapFill: 0.4 },
  },
  {
    name: 'color solid-base',
    image: scene,
    patch: { mode: 'color', paletteSize: 6, layering: 'solid-base' },
  },
  {
    name: 'color solid-base, grouped',
    image: scene,
    patch: { mode: 'color', paletteSize: 6, layering: 'solid-base', groupByColor: true },
  },
  {
    name: 'color tuck, bounded underlay',
    image: scene,
    patch: { mode: 'color', paletteSize: 6, layering: 'tuck', unit: 'px', gapFill: 3 },
  },
