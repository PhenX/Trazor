...
function St(t, e = {}) {
	...
	const P = function(t, e, n, o, r, s, a, i, l, c, f, h, u, d, p, y, g, m, w) {
		...
		if (w > 0 && $ > w) {
			const t = [];
			for (let i = 0; i < o; i++) x(i) === i && t.push(i);
			const e = new Uint8Array(o);
			for (const o of t) e[o] = 1;
			const n = new Int32Array(o).fill(-1), r = new Float64Array(o).fill(1 / 0), s = (t, e) => {
				const n = b(t, e);
				return i[t] * i[e] / (i[t] + i[e]) * n * n;
			}, a = (o) => {
				let a = -1, i = 1 / 0;
				for (const n of t) {
					if (n === o || 0 === e[n]) continue;
					const t = s(o, n);
					(t < i || t === i && n < a) && (i = t, a = n);
				}
				n[o] = a, r[o] = i;
			};
			for (const o of t) a(o);
			for (; $ > w;) {
				let o = -1;
				for (const s of t) 0 === e[s] || n[s] < 0 || (-1 === o || r[s] < r[o]) && (o = s);
				if (-1 === o) break;
				const i = n[o];
				v(o, i), $--;
				const l = x(o), c = l === o ? i : o;
				e[c] = 0, a(l);
				for (const f of t) if (0 !== e[f] && f !== l) if (n[f] === l || n[f] === c) a(f);
				else {
					const t = s(f, l);
					(t < r[f] || t === r[f] && l < n[f]) && (n[f] = l, r[f] = t);
				}
			}
		}
